...
public class PaketIstimewa extends AppCompatActivity {
    ...
    public void loadProduct() {
        ...
        call = RetrofitApi.getInstance().getApiService("").paketIstimewa();
        call.enqueue(new Callback<BaseResponse<ProductResponse>>() {
            ...
            public void onFailure(Call<BaseResponse<ProductResponse>> call, Throwable t) {
                Toast.makeText(PaketIstimewa.this, AppsCore.ERROR_NETWORK, Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
